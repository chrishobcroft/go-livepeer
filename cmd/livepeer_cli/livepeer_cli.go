...
func (w *wizard) initializeOptions() []wizardOpt {
	options := []wizardOpt{
		...
		{desc: "Invoke \"deposit gateway funds\" (ETH)", invoke: w.deposit, notOrchestrator: true},
		{desc: "Invoke \"unlock gateway funds\"", invoke: w.unlock, notOrchestrator: true},
		{desc: "Invoke \"cancel unlock of gateway funds\"", invoke: w.cancelUnlock, notOrchestrator: true},
		{desc: "Invoke \"withdraw gateway funds\"", invoke: w.withdraw, notOrchestrator: true},
		{desc: "Set gateway config", invoke: w.setBroadcastConfig, notOrchestrator: true},
		...
		{desc: "Set price for gateway", invoke: w.setPriceForBroadcaster, orchestrator: true},
