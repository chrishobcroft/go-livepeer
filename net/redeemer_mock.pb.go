...
func (m *MockTicketRedeemerClient) MonitorMaxFloat(ctx context.Context, in *MonitorMaxFloatReq, opts ...grpc.CallOption) (TicketRedeemer_MonitorMaxFloatClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
// MonitorMaxFloat mocks base method.
func (m *MockTicketRedeemerServer) MonitorMaxFloat(arg0 *MonitorMaxFloatReq, arg1 TicketRedeemer_MonitorMaxFloatServer) error {
	m.ctrl.T.Helper()
