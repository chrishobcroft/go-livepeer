...
type SenderManager interface {
	...
	// SubscribeSenderInfoChange notifies a subcriber when the senderInfo for a sender changes
	SubscribeSenderInfoChange(sink chan<- ethcommon.Address) event.Subscription
}
